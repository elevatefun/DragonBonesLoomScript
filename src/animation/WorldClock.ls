    ...
    */
    ...
    public final class WorldClock implements IAnimatable
    {
        ...
        public function WorldClock()
        {
            ...
            //_time = timeManager.platformTime * 0.001;
        ...
        {
            var index:int = int(_animatableList.indexOf(animatable));
            if (index >= 0)
            {
        ...
        {
            if(!passedTime || passedTime < 0)
            {
                var currentTime:Number = timeManager.platformTime * 0.001;
            ...
            if (currentIndex != i)
            {
                ...
                while(i < length)
                {
                    if(_animatableList[currentIndex + 1]){
                        _animatableList[currentIndex + 1] = _animatableList[i + 1];
                    }else {
                        _animatableList.push(_animatableList[i + 1]);
                    }
                }
            }
        }
