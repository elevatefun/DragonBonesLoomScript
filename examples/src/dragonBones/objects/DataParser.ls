package dragonBones.objects {
    ...
    public final class DataParser
    {
        ...
        //    var dataType:String = BytesType.getByteType(bytes);
        ...
        public static function parseSkeletonData(filePath:String):SkeletonData {
            ...
            if(filePath.lastIndexOf('.json') > -1){
                ...
                return parser.parseSkeletonData(filePath);

            }else if(filePath.lastIndexOf('.xml') > -1){

                return XMLDataParser.parseSkeletonData(filePath);
            }
        ...
        //        return JSONDataParser.parseSkeletonData(data as JSON);

        //    } else if(data is XML) {

        //        return XMLDataParser.parseSkeletonData(data as XML);

        //    } else {

        //        return ObjectDataParser.parseSkeletonData(data);
        //    }
